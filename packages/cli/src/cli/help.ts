...
Usage:
  ...
  skopos verify <task-id> [target] [--phase <admission|iteration|stabilization|closure>] [--compact] [--dry-run] [--json]
  ...
  skopos evidence record-observation <task-id> [target] [--requirement <id>] [--guard <id>] --statement <text> --actor <id> [--compact] [--dry-run] [--json]
  skopos task show <task-id> [target] [--compact] [--json]
  ...
  skopos task verify <task-id> [target] --actor <id> [--compact] [--json]
