...
- Status: `active`
- Owner: `skopos-core`
- Scope: `policy-packs/gates/progressive-validation/lane-guide`
- Canonical: `yes`
...
| Workpack | Public API, architecture, stack, security, migration, generated artifact, multi-package, or long-running work | staged checks, decisions, findings, eval, and closure proof |
