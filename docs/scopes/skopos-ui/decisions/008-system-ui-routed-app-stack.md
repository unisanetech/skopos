...
> Current boundary: this Decision owns the React, Vite, routed-app, projection, and local delivery stack. The human-first supervision and browser-history Decisions own the current route taxonomy, navigation labels, and URL behavior.
