# Skopos Human Guidance And Developer Experience Plan

Use this plan to make Skopos understandable for real developers, not only readable by LLM agents.

## Metadata

- Doc ID: `SKOPOS-PROJECT-HUMAN-GUIDANCE-AND-DEVELOPER-EXPERIENCE-PLAN`
- Status: `active`
- Owner: `skopos-core`
