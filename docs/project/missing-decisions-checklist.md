...
- Doc ID: `SKOPOS-PROJECT-MISSING-DECISIONS-CHECKLIST`
- Status: `active`
- Owner: `skopos-core`
...
- Current state:
  - the first mission-level coordination slice is now defined through `../decisions/007-multi-actor-mission-coordination.md`
...
1. Expand the proof harness and fixture matrix using the shared scorecard contract in `proof-phase-plan.md`.
