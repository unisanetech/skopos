...
status: superseded
owner: skopos-core
id: SKOPOS-038-SKOPOS-SELF-HOSTING-MODE-AND-COMPATIBILITY-BOUNDARIES
scope: skopos
role: decision
...
> Skopos has not launched, so internal and public
> prototype surfaces are cleanly replaced without compatibility aliases or migrations.
