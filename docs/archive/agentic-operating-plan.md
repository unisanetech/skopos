...
status: superseded
owner: skopos-core
id: SKOPOS-AGENTIC-OPERATING-PLAN
scope: skopos
role: plan
...
> **Superseded:** The canonical pre-release direction is
> [`../work/plans/P-e7e888e6-canonical-product-convergence.md`](../work/plans/P-e7e888e6-canonical-product-convergence.md),
> governed by
> [Decision D-8d32a27b](../decisions/D-8d32a27b-canonical-project-memory-task-and-coordination-contract.md).
> This archived document remains only as historical prototype input.
...
The prototype `start`/`next`/`eval`/`trust`/`done` surface described here was implemented
at the time of this plan. The canonical convergence Plan—not this archive document—owns
its clean replacement.
...
### Slice 4: Agent-Led Understanding (Historical Slice)
