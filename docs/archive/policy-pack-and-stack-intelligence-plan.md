---
title: Skopos Policy Pack And Stack Intelligence Plan
status: superseded
owner: skopos-core
id: SKOPOS-PROJECT-POLICY-PACK-AND-STACK-INTELLIGENCE-PLAN
scope: skopos
role: plan
...
- `2026-07-28`: Superseded by the canonical convergence Plan. Useful Policy and Skill
  behavior moves into Profiles, Memory, Actions, and Guards; permanent role mapping,
  Workflow packs, Gate packs, and duplicate authority are rejected.
