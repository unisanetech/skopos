...
- Doc ID: `SKOPOS-F-20260725-AGENT-NATIVE-SINGLE-CONTROL-PLANE-AND-CONTEXT-ECONOMY-GAP`
- Status: `active`
- Owner: `skopos-core`
...
- Related Docs:
  ...
  - `../project/execution/P1-W11-agent-native-single-control-plane-convergence.md`
