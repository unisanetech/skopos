---
title: "F-20260627-workflow-recording-preflight-gap: Cross-Cutting Agent Work
  Could Bypass Skopos Recording Until After Implementation"
status: fixed
owner: skopos-core
id: SKOPOS-F-20260627-WORKFLOW-RECORDING-PREFLIGHT-GAP
scope: skopos
role: finding
...
relatedDocs:
  - ../README.md
  - ../../decisions/archive/032-workflow-recording-preflight-guard.md
...
1. `../README.md`
2. `../../decisions/archive/032-workflow-recording-preflight-guard.md`
3. `../../architecture/action-extension-model.md`
