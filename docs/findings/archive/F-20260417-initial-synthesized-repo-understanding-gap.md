---
title: "F-20260417-initial-synthesized-repo-understanding-gap: Brownfield
  Onboarding Still Leans Too Hard On Raw Artifacts Instead Of A Compact Repo
  Understanding Layer"
status: fixed
owner: skopos-core
id: SKOPOS-F-20260417-INITIAL-SYNTHESIZED-REPO-UNDERSTANDING-GAP
scope: skopos
role: finding
...
3. `../../domains/product/positioning.md`
