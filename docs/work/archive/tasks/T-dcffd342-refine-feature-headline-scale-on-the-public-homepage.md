---
title: "Task: Refine feature headline scale on the public homepage"
status: complete
owner: "codex"
id: T-dcffd342
scope: "skopos"
...
proofBaseline: baseline-0d562e6bc394cf8e
lastUpdated: 2026-08-10
---

# Task: Refine feature headline scale on the public homepage
...
Refine feature headline scale on the public homepage

## Acceptance

- Promise and boundary headlines are visibly calmer while section numbers retain their current prominence.
- Desktop and mobile layouts preserve readable wrapping without horizontal overflow.
...
- [x] **Implement the smallest scoped change** (implementation, complete) — Carry out "Refine feature headline scale on the public homepage" inside the resolved scope before widening impact to adjacent areas.
...
- Promise and boundary headlines are visibly calmer while section numbers retain their current prominence. (closure, agent-observation)
- Desktop and mobile layouts preserve readable wrapping without horizontal overflow. (closure, agent-observation)
...
```json
{
  ...
  "type": "task",
  "status": "durable",
  "generatedAt": "2026-08-10T22:44:17.206Z",
  "updatedAt": "2026-08-10T22:46:35.082Z",
  "planIds": [],
  "childTasks": [],
  "state": "complete",
  "detail": "standard",
  "title": "Refine feature headline scale on the public homepage",
  "goal": "Refine feature headline scale on the public homepage",
  "scope": {
    "query": "workspace",
  ...
  "proofSubject": {
    "kind": "task-closure",
    "baselineId": "baseline-0d562e6bc394cf8e"
  },
  "priority": 0,
  "dependencyTaskIds": [],
  "steps": [
    ...
    },
    {
      ...
      "detail": "Carry out \"Refine feature headline scale on the public homepage\" inside the resolved scope before widening impact to adjacent areas.",
      "status": "complete"
    },
    {
  ...
  "evidenceRequirements": [
    {
      "id": "acceptance-1",
      "acceptanceCriterion": "Promise and boundary headlines are visibly calmer while section numbers retain their current prominence.",
      "phase": "closure",
      "actionIds": [],
      "guardIds": [],
    ...
    {
      "id": "acceptance-2",
      "acceptanceCriterion": "Desktop and mobile layouts preserve readable wrapping without horizontal overflow.",
      "phase": "closure",
      "actionIds": [],
      "guardIds": [],
      "evidence": "agent-observation"
  ...
  "questions": [
    {
      ...
      "resolvedAt": "2026-08-10T22:44:31.896Z",
    ...
    },
    {
      ...
      "resolvedAt": "2026-08-10T22:44:30.740Z",
      "resolvedByActorId": "codex"
    }
  ],
  "recommendations": [
