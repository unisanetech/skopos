---
title: "Task: Correct the Product Interface Design public asset boundary documentation"
status: complete
owner: "codex"
id: T-0cdfea4f
scope: "skopos"
...
proofBaseline: baseline-452f73415d6410a4
lastUpdated: 2026-08-09
---

# Task: Correct the Product Interface Design public asset boundary documentation
...
Correct the Product Interface Design public asset boundary documentation

## Acceptance

- The public package guide states the exact 40-file reviewed allowlist and identifies the Design Context assets
- Package boundary and release surface tests pass

## Non-Goals

- Change the public package contents or publish anything
...
- [x] **Implement the smallest scoped change** (implementation, complete) — Carry out "Correct the Product Interface Design public asset boundary documentation" inside the resolved scope before widening impact to adjacent areas.
...
- The public package guide states the exact 40-file reviewed allowlist and identifies the Design Context assets (closure, agent-observation)
- Package boundary and release surface tests pass (closure, agent-observation)
...
```json
{
  ...
  "type": "task",
  "status": "durable",
  "generatedAt": "2026-08-09T18:05:37.992Z",
  "updatedAt": "2026-08-09T18:11:28.317Z",
  "planIds": [],
  "childTasks": [],
  "state": "complete",
  "detail": "standard",
  "title": "Correct the Product Interface Design public asset boundary documentation",
  "goal": "Correct the Product Interface Design public asset boundary documentation",
  "scope": {
    "query": "workspace",
  ...
  "proofSubject": {
    "kind": "task-closure",
    "baselineId": "baseline-452f73415d6410a4"
  },
  "priority": 0,
  "dependencyTaskIds": [],
  "steps": [
    ...
    },
    {
      ...
      "detail": "Carry out \"Correct the Product Interface Design public asset boundary documentation\" inside the resolved scope before widening impact to adjacent areas.",
      "status": "complete"
    },
    {
  ...
  "evidenceRequirements": [
    {
      "id": "acceptance-1",
      "acceptanceCriterion": "The public package guide states the exact 40-file reviewed allowlist and identifies the Design Context assets",
      "phase": "closure",
      "actionIds": [],
      "guardIds": [],
    ...
    {
      "id": "acceptance-2",
      "acceptanceCriterion": "Package boundary and release surface tests pass",
      "phase": "closure",
      "actionIds": [],
      "guardIds": [],
      "evidence": "agent-observation"
  ...
  "memoryObligations": [
    {
      ...
      "resolutionReason": "Corrected the canonical architecture document to the exact reviewed 40-asset boundary.",
      "resolvedAt": "2026-08-09T18:11:13.680Z",
  ...
  "questions": [
    {
      ...
      "resolvedAt": "2026-08-09T18:06:10.486Z",
      "resolvedByActorId": "codex"
    },
    {
      ...
      "resolvedAt": "2026-08-09T18:06:16.146Z",
      "resolvedByActorId": "codex"
    }
  ],
  "recommendations": [
