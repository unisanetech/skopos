...
# Task: Make the public Skill asset boundary portable on Windows
...
Make the public Skill asset boundary portable on Windows

## Acceptance

- Windows and POSIX asset paths normalize to one portable slash-separated identity before allowlist comparison
- A platform-independent regression test covers both Windows-style and POSIX-style input paths
- Build, focused package tests, and replacement GitHub runtime matrix pass

## Non-Goals

- Change the reviewed public Skill asset inventory

## Constraints

- Preserve the fail-closed exact allowlist comparison
...
- `packages/cli/scripts/portable-path.d.mts`
- `packages/cli/scripts/portable-path.mjs`
...
- [x] **Implement the smallest scoped change** (implementation, complete) — Carry out "Make the public Skill asset boundary portable on Windows" inside the resolved scope before widening impact to adjacent areas.
...
- Windows and POSIX asset paths normalize to one portable slash-separated identity before allowlist comparison (closure, agent-observation)
- A platform-independent regression test covers both Windows-style and POSIX-style input paths (closure, agent-observation)
- Build, focused package tests, and replacement GitHub runtime matrix pass (closure, agent-observation)
...
```json
{
  ...
  "proofSubject": {
    "kind": "task-closure",
    "baselineId": "baseline-757bba3369033173"
  },
  "priority": 0,
  "dependencyTaskIds": [],
  "steps": [
    ...
    },
    {
      ...
      "detail": "Carry out \"Make the public Skill asset boundary portable on Windows\" inside the resolved scope before widening impact to adjacent areas.",
      "status": "complete"
    },
    {
  ...
  "evidenceRequirements": [
    {
      "id": "acceptance-1",
      "acceptanceCriterion": "Windows and POSIX asset paths normalize to one portable slash-separated identity before allowlist comparison",
      "phase": "closure",
      "actionIds": [],
      "guardIds": [],
    ...
    {
      "id": "acceptance-2",
      "acceptanceCriterion": "A platform-independent regression test covers both Windows-style and POSIX-style input paths",
      "phase": "closure",
      "actionIds": [],
      "guardIds": [],
      "evidence": "agent-observation"
    ...
    {
      "id": "acceptance-3",
      "acceptanceCriterion": "Build, focused package tests, and replacement GitHub runtime matrix pass",
      "phase": "closure",
      "actionIds": [],
      "guardIds": [],
      "evidence": "agent-observation"
  ...
  "questions": [
    {
      ...
      "resolvedAt": "2026-08-09T18:42:15.343Z",
    ...
    },
    {
      ...
      "resolvedAt": "2026-08-09T18:42:16.467Z",
      "resolvedByActorId": "codex"
    }
  ],
  "recommendations": [
