---
title: "Task: Apply full-viewport horizontal rules to the public homepage"
status: complete
owner: "codex"
id: T-aff87e54
scope: "skopos"
...
proofBaseline: baseline-630f8647b162b186
lastUpdated: 2026-08-10
---

# Task: Apply full-viewport horizontal rules to the public homepage
...
Apply full-viewport horizontal rules to the public homepage

## Acceptance

- Horizontal section and internal-row dividers span the viewport while content remains aligned to the shared max-width rail.
- Desktop and mobile layouts have no horizontal overflow and preserve responsive padding.
...
- [x] **Implement the smallest scoped change** (implementation, complete) — Carry out "Apply full-viewport horizontal rules to the public homepage" inside the resolved scope before widening impact to adjacent areas.
...
- Horizontal section and internal-row dividers span the viewport while content remains aligned to the shared max-width rail. (closure, agent-observation)
- Desktop and mobile layouts have no horizontal overflow and preserve responsive padding. (closure, agent-observation)
...
```json
{
  ...
  "type": "task",
  "status": "durable",
  "generatedAt": "2026-08-10T18:44:51.788Z",
  "updatedAt": "2026-08-10T18:50:52.217Z",
  "planIds": [],
  "childTasks": [],
  "state": "complete",
  "detail": "standard",
  "title": "Apply full-viewport horizontal rules to the public homepage",
  "goal": "Apply full-viewport horizontal rules to the public homepage",
  "scope": {
    "query": "workspace",
  ...
  "proofSubject": {
    "kind": "task-closure",
    "baselineId": "baseline-630f8647b162b186"
  },
  "priority": 0,
  "dependencyTaskIds": [],
  "steps": [
    ...
    },
    {
      ...
      "detail": "Carry out \"Apply full-viewport horizontal rules to the public homepage\" inside the resolved scope before widening impact to adjacent areas.",
      "status": "complete"
    },
    {
  ...
  "evidenceRequirements": [
    {
      "id": "acceptance-1",
      "acceptanceCriterion": "Horizontal section and internal-row dividers span the viewport while content remains aligned to the shared max-width rail.",
      "phase": "closure",
      "actionIds": [],
      "guardIds": [],
    ...
    {
      "id": "acceptance-2",
      "acceptanceCriterion": "Desktop and mobile layouts have no horizontal overflow and preserve responsive padding.",
      "phase": "closure",
      "actionIds": [],
      "guardIds": [],
      "evidence": "agent-observation"
  ...
  "questions": [
    {
      ...
      "resolvedAt": "2026-08-10T18:45:13.187Z",
    ...
    },
    {
      ...
      "resolvedAt": "2026-08-10T18:45:14.563Z",
      "resolvedByActorId": "codex"
    }
  ],
  "recommendations": [
